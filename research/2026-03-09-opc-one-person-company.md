...
>
> 2026-03-09 创建 · 2026-03-11 更新至 v1.4 | 喵神 & 大仙
...
| 版本 | 下载 | 大小 | 说明 |
|------|------|------|------|
| **v1.4**（最新） | [agent-orchestration-v1.4.tar.gz](/assets/skills/agent-orchestration-v1.4.tar.gz) | 37KB | 20文件 / 3213行 |
...
```bash
cd ~/.openclaw/skills
tar xzf agent-orchestration-v1.4.tar.gz
```
...
│   ├── cost-tracking.md                 # 成本追踪（v1.4 自动化增强）
│   ├── collaboration-patterns.md        # 协作模式
│   ├── project-state.md                 # 项目状态持久化规范 ← v1.4 新增
...
├── scenarios/
│   └── marketing-campaign.md            # 营销活动全链路案例（305行）
└── scripts/
    ├── project_state.py                 # 项目状态管理器 ← v1.4 核心新增
    ├── diagnose_agent.py                # 自动归因工具 ← v1.4 新增
    ├── project_tracker.py               # 项目追踪（旧版，仍可用）
    └── cost_summary.sh                  # 成本汇总（旧版，仍可用）
```
...
*喵神 & 大仙 | 2026-03-09 创建 · 2026-03-11 更新 | OPC — AI Agent 的公司制度*
